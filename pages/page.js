(function () {
  ...
  const copy = {
    ru: {
      ...
      about: `Меня зовут Евгений. Я люблю учиться, разбираться в новом и придумывать, как сделать сложные вещи проще.
      ...
      laboratory: `Этот раздел пока в разработке. Здесь будут появляться мои эксперименты, небольшие приложения и технические проекты.`,

      contacts: `Если хотите связаться со мной, проще всего сделать это одним из способов ниже.
    ...
    en: {
      ...
      analytics: `I created a separate Yandex DataLens dashboard for my data analytics projects.
      ...
      about: `My name is Evgeny. I enjoy learning, exploring new things, and finding ways to make complex things simpler.
      ...
      laboratory: `This section is still in development. It will eventually feature my experiments, small applications, and technical projects.`,

      contacts: `If you'd like to get in touch, you can reach me through any of the options below.
